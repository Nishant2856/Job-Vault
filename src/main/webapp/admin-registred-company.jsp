  ...
  <body>
    ...
    <main class="h_main">
      <div class="grid-container">
       ...
       <c:forEach var="e" items="${companies}">
    
		
        <div class="grid-item">
      <img src="assets/image/${e.logo }" alt="" />
          <div class="gring-info">
          ...
          <p>Leading Provider of transformational solutions.</p>

          <div class="act">
            <button><a href="companyJobs?c_id=${e.c_id }">View jobs</a></button>
            <a href="deletecompany?c_id=${e.c_id }">
              <svg
                width="35"
                height="35"
                viewBox="0 0 35 35"
                ...
                xmlns:xlink="http://www.w3.org/1999/xlink"
              >
                <rect width="35" height="35" fill="url(#pattern0_174_79)" />
                <defs>
                  <pattern
                    id="pattern0_174_79"
                    patternContentUnits="objectBoundingBox"
